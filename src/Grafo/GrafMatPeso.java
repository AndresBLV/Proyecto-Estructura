...
public static int INFINITO = 0;
     ...
     */
    public static GrafMatPeso desdeListas(ListaCliente clientes, ListaAlmacen almacenes, ListaRutas rutas) {
        ...
        if (!almacenes.esta_vacia()) {
            NodoAlmacene almacen = almacenes.getPrimero();
            while (almacen != null) {                
                grafo.nuevoVertice(new VerticeAlmacen(almacen));
